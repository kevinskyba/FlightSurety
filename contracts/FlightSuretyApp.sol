...
contract FlightSuretyApp {
    ...
    */   
    function registerAirline
                            ...
                            returns(bool)
    {
        uint256 airlines = flightSuretyData.getNumberOfRegisteredAirlines();
        if (airlines < 4)
        {
            flightSuretyData.registerAirline(msg.sender, newAirline);
        }else{
            if (flightSuretyData.getVotes(newAirline).mul(100).div(airlines) >= 50) {
                flightSuretyData.registerAirline(msg.sender, newAirline);
            } else {
                return false;
            }
    ...
    function voteAirline(address airline)
                            external {
        flightSuretyData.vote(msg.sender, airline);
    }
    ...
    */  
    ...
    function buyInsurance(string memory flight) public payable {
        return flightSuretyData.buy.value(msg.value)(msg.sender, flight);
    }
